...
<body>
    ...
    <div class="content">
        ...
        <p>
            Sehubungan surat ini, perusahaan memberikan surat peringatan kedua (SP-{{ $data->status }}) sebagai bentuk teguran atas
        ...
        <ul>
            <li>Tanggal : {{ $data->created_at->format('d M Y') }}</li>
            <li>Apabila teguran SP-{{ $data->status }} ini tidak ditanggapi dengan baik, maka dengan terpaksa perusahaan
                akan menindaklanjuti sebagaimana kelayakan perusahaan.
            </li>
        </ul>

        <p>
            Demikian Surat Peringatan {{ $data->status }} ini diterbitkan agar dilaksanakan sebagaimana mestinya. Diharapkan
